...
import { ColumnVisWithInputComponent } from './example-with-input/example-with-input';
import { CodeFile } from '../../../../interfaces/code-file';
import { ColumnVisWithElementsComponent } from './example-with-elements/example-with-elements';
...
@Component({
  ...
  imports: [
    ...
    ColumnVisWithInputComponent,
    ColumnVisWithElementsComponent,
  ],
...
export class ColumnVisibilityComponent {
  ...
  codeFilesWithInput: CodeFile[] = [
    ...
    },
    {
      ...
      code: `
        <button style="margin: 5px" (click)="toggle()">Show/hide 'e-mail' column</button>
        <d-grid [style.height.%]="87" [data]="gridData()" [columns]="columns()"> </d-grid>
      `,
      lang: 'html',
      showLineNumbers: true,
    },
  ...
  codeFilesWithElements: CodeFile[] = [
    ...
    },
    {
      ...
      code: `
        <button style="margin: 5px" (click)="toggle()">Show/hide 'e-mail' column</button>
        <d-grid [style.height.%]="87" [data]="gridData()">
