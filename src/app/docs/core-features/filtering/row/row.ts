...
import { FilterRowExampleComponent } from './example/example';
import { CodeFile } from '../../../../interfaces/code-file';

@Component({
  selector: 'docs-core-features-filtering-row',
  imports: [LiveExampleComponent, FilterRowExampleComponent],
  templateUrl: './row.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FilteringFilterRowComponent {
  codeFiles: CodeFile[] = [
    {
      fileName: 'example.ts',
      code: `
          ...
          @Component({
            selector: 'docs-core-features-filtering-filter-row-example',
            imports: [D_GRID],
            templateUrl: './example.html',
            changeDetection: ChangeDetectionStrategy.OnPush,
          })
          export class FilterRowExampleComponent implements OnInit {
            gridData = signal<Row[]>([]);
    ...
    },
    {
      ...
      code: `
        <d-grid [style.height.%]="87" [data]="gridData()" [asyncData]="true" [filterable]="true">
