...
import { RowStickyExampleComponent } from './example/example';
import { CodeFile } from '../../../../interfaces/code-file';

@Component({
  selector: 'docs-core-features-rows-sticky',
  imports: [CodeBlockComponent, LiveExampleComponent, RowStickyExampleComponent],
...
export class RowStickyComponent {
  ...
  codeFiles: CodeFile[] = [
    ...
    },
    {
      ...
      code: `
        <d-grid [style.height.%]="87" [data]="gridData()" [asyncData]="true" [stickyRows]="rowIsSticky">
