...
import { RowAnimatedExampleComponent } from './example/example';
import { CodeFile } from '../../../../interfaces/code-file';

@Component({
  selector: 'docs-core-features-rows-animated',
  imports: [LiveExampleComponent, RowAnimatedExampleComponent],
...
export class RowAnimatedComponent {
  codeFiles: CodeFile[] = [
    ...
    },
    {
      ...
      code: `
        <d-grid [style.height.%]="87" [data]="gridData()" [asyncData]="true" [animatedRows]="true">
