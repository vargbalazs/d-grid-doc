...
import { SelectionCellExampleComponent } from './example/example';
import { CodeFile } from '../../../../interfaces/code-file';

@Component({
  selector: 'docs-core-features-selection-cell',
  imports: [LiveExampleComponent, SelectionCellExampleComponent],
...
@Component({
  selector: 'docs-core-features-selection-cell-example',
  imports: [D_GRID],
  templateUrl: './example.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SelectionCellExampleComponent implements OnInit {
  gridData = signal<Row[]>([]);
...
<d-grid
  ...
  [asyncData]="true"
  filterable="excel"
  [selectable]="{ withKeyboard: true, withMouse: true }"
>
